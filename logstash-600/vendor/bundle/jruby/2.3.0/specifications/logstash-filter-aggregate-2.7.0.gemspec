# -*- encoding: utf-8 -*-
# stub: logstash-filter-aggregate 2.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "The aim of this filter is to aggregate information available among several events (typically log lines) belonging to a same task, and finally push aggregated information into final task event.".freeze
