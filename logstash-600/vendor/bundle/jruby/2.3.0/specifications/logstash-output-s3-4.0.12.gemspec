# -*- encoding: utf-8 -*-
# stub: logstash-output-s3 4.0.12 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "This plugin was created for store the logstash's events into Amazon Simple Storage Service (Amazon S3)".freeze
